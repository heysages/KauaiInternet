import { partnerNeeds } from "@/data/partnerNeeds";
...
export default function PartnersNeedsSection() {
  return (
    <section id="partners" className="section-padding gradient-ocean text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div>
            ...
            <p className="text-mist text-lg leading-relaxed mb-8">
              This is a civic infrastructure movement — not a telecom sales pitch.
              We need landowners, agencies, funders, and volunteers to build
              something Kauai owns together.
            </p>
            <a
              href="#support"
              className="inline-flex items-center gap-2 bg-amber-emergency hover:bg-amber-glow text-ocean-deep font-semibold px-6 py-3.5 rounded-xl transition-colors"
            >
              Offer your support
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {partnerNeeds.map((need) => (
              <div
                key={need.id}
                className="bg-white/6 border border-white/12 rounded-2xl p-5 hover:bg-white/10 transition-colors"
              >
                <div className="w-10 h-10 rounded-xl bg-amber-emergency/15 text-amber-glow flex items-center justify-center mb-4">
                  {needIcons[need.id]}
                </div>
